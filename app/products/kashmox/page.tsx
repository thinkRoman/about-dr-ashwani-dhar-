        ...
        <div className="bg-[#03211b] text-white/60 border-b border-white/10">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <span>/</span>
              <span className="text-white font-medium">KashMOX 625</span>
            </nav>
          </div>
        </div>
          ...
          <div className="relative container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="inline-flex items-center gap-2 bg-white/10 text-signal-bright border border-white/15 px-4 py-2 rounded-full text-sm font-semibold mb-4">
                  <Pill className="h-4 w-4" />
                  TrPharma Flagship Product
                </div>
                
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white">
                  <span className="text-signal-bright">KashMOX</span> 625
                </h1>
                ...
                <p className="text-lg text-white/65 mb-6 leading-relaxed">
                  <strong className="text-white">KashMOX 625</strong> is TrPharma&apos;s flagship broad-spectrum antibiotic, developed under the medical leadership of <Link href="/" className="text-signal-bright hover:underline font-semibold">Dr. Ashwani Dhar MD DMI</Link>. Combining Amoxicillin with Clavulanic Acid for enhanced efficacy against resistant bacteria.
                </p>
